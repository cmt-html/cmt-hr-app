    ...
    <div className="space-y-8 animate-slide-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white border border-slate-100 p-6 rounded-2xl dark:bg-slate-900 dark:border-slate-800 shadow-sm hover-premium">
          <div className="flex items-center justify-between">
            <span className="text-[13px] font-bold text-slate-450 uppercase tracking-widest">Headcount</span>
            <span className="p-2.5 rounded-xl bg-indigo-50 text-indigo-600 dark:bg-indigo-950/30 dark:text-indigo-400">
              <Users size={20} />
            </span>
          </div>
          <p className="text-3xl font-extrabold text-slate-800 dark:text-white mt-4 font-outfit">{stats.employees}</p>
        ...
        <div className="bg-white border border-slate-100 p-6 rounded-2xl dark:bg-slate-900 dark:border-slate-800 shadow-sm hover-premium">
          <div className="flex items-center justify-between">
            <span className="text-[13px] font-bold text-slate-450 uppercase tracking-widest">Pending Leaves</span>
            <span className="p-2.5 rounded-xl bg-purple-50 text-purple-600 dark:bg-purple-950/30 dark:text-purple-400">
              <Calendar size={20} />
            </span>
          </div>
          <p className="text-3xl font-extrabold text-slate-800 dark:text-white mt-4 font-outfit">{stats.pendingLeaves}</p>
        ...
        <div className="bg-white border border-slate-100 p-6 rounded-2xl dark:bg-slate-900 dark:border-slate-800 shadow-sm hover-premium">
          <div className="flex items-center justify-between">
            <span className="text-[13px] font-bold text-slate-450 uppercase tracking-widest">Help Tickets</span>
            <span className="p-2.5 rounded-xl bg-rose-50 text-rose-600 dark:bg-rose-950/30 dark:text-rose-400">
              <HelpCircle size={20} />
            </span>
          </div>
          <p className="text-3xl font-extrabold text-slate-800 dark:text-white mt-4 font-outfit">{stats.openTickets}</p>
        ...
        <div className="bg-white border border-slate-100 p-6 rounded-2xl dark:bg-slate-900 dark:border-slate-800 shadow-sm hover-premium">
          <div className="flex items-center justify-between">
            <span className="text-[13px] font-bold text-slate-450 uppercase tracking-widest">Active Jobs</span>
            <span className="p-2.5 rounded-xl bg-amber-50 text-amber-600 dark:bg-amber-950/30 dark:text-amber-400">
              <ArrowUpRight size={20} />
            </span>
          </div>
          <p className="text-3xl font-extrabold text-slate-800 dark:text-white mt-4 font-outfit">{stats.openJobs}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-6 dark:bg-slate-900 dark:border-slate-800 shadow-sm">
            <div className="border-b border-slate-100 pb-4 mb-6 dark:border-slate-800 flex items-center justify-between">
              <div>
                <h3 className="text-lg font-bold text-slate-800 dark:text-white font-outfit">Shift Attendance Clock</h3>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="text-center md:text-left space-y-1">
                ...
                <p className="text-4xl md:text-5xl font-extrabold text-slate-850 dark:text-white font-mono tracking-tight">{duration}</p>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-6 dark:bg-slate-900 dark:border-slate-800 shadow-sm">
            <h3 className="text-lg font-bold text-slate-800 dark:text-white mb-6 font-outfit">Department Headcount Distributions</h3>
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          {isManager && (
            <div className="bg-white border border-slate-100 rounded-3xl p-6 dark:bg-slate-900 dark:border-slate-800 shadow-sm">
              <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-4 dark:border-slate-800">
                <h3 className="text-[14px] font-bold text-slate-800 dark:text-white font-outfit">Pending Approvals</h3>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2.5">
                          ...
                          <div>
                            ...
                            <p className="text-[9px] text-slate-400">{req.type} Leave</p>
                          </div>
                        </div>
                      </div>
          ...
          {/* Announcements Feed */}
          <div className="bg-white border border-slate-100 rounded-3xl p-6 dark:bg-slate-900 dark:border-slate-800 shadow-sm">
            <h3 className="text-[14px] font-bold text-slate-800 dark:text-white border-b border-slate-100 pb-4 mb-4 dark:border-slate-800 font-outfit">Company Announcements</h3>
